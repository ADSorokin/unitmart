...
if( !class_exists("ModuleSample") ) {
	class ModuleSample {
		...
		public static function getStoreConfigs(){
			return array(
					'theme_default_image_category_width'    => 960,
					'theme_default_image_category_height'   => 199,

					'theme_default_image_thumb_width'       => 500,
					'theme_default_image_thumb_height'      => 445,

					'theme_default_image_popup_width'       => 550,
					'theme_default_image_popup_height'      => 445,

					'theme_default_image_product_width'     => 500,
					'theme_default_image_product_height'    => 445,

					'theme_default_image_additional_width'  => 500,
					'theme_default_image_additional_height' => 445,

					'theme_default_image_related_width'     => 500,
					'theme_default_image_related_height'    => 445,

					'theme_default_image_compare_width'     => 90,
					'theme_default_image_compare_height'    => 80,

					'theme_default_image_wishlist_width'    => 90,
					'theme_default_image_wishlist_height'   => 80,

					'theme_default_image_cart_width'        => 120,
					'theme_default_image_cart_height'       => 107,
			);
		}
